 ...
 * @param defaultControls - Whether to use default controls (true) or custom controls (false)
 * @param ref - Ref to expose imperative methods for controlling the video
 */
const Video = forwardRef(
  ({ src, defaultControls }: { src: string; defaultControls?: boolean }, ref: any) => {
    ...
    return (
      <video
        playsInline
        ref={videoRef}
        controls={defaultControls ? true : false}
